...
const ProductPage = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen font-sans">
      <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center">🛒 Explore Products</h1>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <main className="col-span-12 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 overflow-y-auto max-h-[80vh] pr-2">
        ...
        <aside className="col-span-12 lg:col-span-3 bg-white p-6 rounded-2xl shadow-md">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Featured Products</h2>
          <div className="space-y-4 ">
